package ru.ncedu.consoleapp.menu.commands.citys.utils;
...
public class CityCommandsUtils 
{
    ...
    {
        IOUtils.printSeparator();
        System.out.println("Enter PhoneExtension of this city:");
        IOUtils.printPrompt();
        ...
        {
            IOUtils.printSeparator();
            System.out.println("PhoneExtension can't be empty");
